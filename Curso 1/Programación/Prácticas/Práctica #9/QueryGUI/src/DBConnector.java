...
public class DBConnector {
    ...
    public String getUrl() {
        return DEFAULT_URL + getDataBaseName();
    }
    ...
    public boolean establishConnection(String db, String user, String password) {
        try {
            m_Connection = DriverManager.getConnection(DEFAULT_URL + db,
