package coleccion_poo3.vehiculo_alt;
...
public class Vehiculo2 {
    ...
    private double ajustarVelocidad() {
        return switch(m_Marcha) {
            case 1 -> m_Velocidad = 10;
            case 2 -> m_Velocidad = 30;
            case 3 -> m_Velocidad = 60;
            case 4 -> m_Velocidad = 90;
            case 5 -> m_Velocidad = 120;
            default -> m_Velocidad = 0;
        };
    }
    ...
    public void setMarcha(byte marcha) {
        if (!(marcha >= 0 && marcha <= 5)) {
            System.out.print("Valor de marcha no válido.");
            return;
        }
