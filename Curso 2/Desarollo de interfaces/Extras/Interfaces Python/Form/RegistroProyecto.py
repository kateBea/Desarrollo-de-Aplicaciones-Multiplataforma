...
class registroProyectos():
    ...
    def __init__(self, ventana):
        ...
        txtIntegrantes = CTkTextbox(frame, width=220, height=100, font=('Robotopo', 12), text_color="#FCAC15", border_color=c_verde, fg_color=COLOR_FRAME_PRINCIPAL, corner_radius=12, scrollbar_button_color=c_morado, border_width=2)
        txtIntegrantes.grid(column=1, row=2, pady=5, padx=10)
