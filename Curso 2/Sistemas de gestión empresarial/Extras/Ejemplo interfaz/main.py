...
passwd = CTkEntry(frame, show="*", font=('sans serif', 18), text_color=(c_morado),  placeholder_text='contraseña', border_color = c_verde, fg_color=c_negro, width=220, height=40)
