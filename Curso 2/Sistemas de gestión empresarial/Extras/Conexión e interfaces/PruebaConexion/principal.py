...
'''Importo tkinter para generar la interface. Le pongo el
alias tk para no tener que estar escribiendo siempre tkinter'''
import tkinter as tk;

import conexionBBDD as cn;

'''Llamamos al método creado en nuestra clase para abrir la BBDD. Le 
pasamos como parámetros el huesped, el usuario y la password. Guardo 
la instanciación en miConexión para trabajar sobre esta conexión.'''
